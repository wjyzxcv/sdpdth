...
#' 
#' @param th_res msdpdth class, output from msdpdth
#' 
#' 
#' @details Two sided Wald test for testing whether two parameters for each groups are equal
#' \itemize{
#' \item{"h_0"} {\eqn{\theta_1 = \theta_2}}
#' \item{"h_1"} {\eqn{\theta_1 \neq \theta_2}}
#' }
#' 
#' @return A list of p-values for each parameters.
#' 
#' @export
#' 
#' 
